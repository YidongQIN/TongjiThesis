...
\makecover*{../data/cover} % 中英文封面，带*则无书脊
\makeauthorizationpage%[../data/scanauth.pdf] % 授权书
\makedeclarepage%[../data/scandecl.pdf] % 原创声明
...
\begin{appendix}% 附录
  \subfile{../data/appendix.tex}
\end{appendix}
\input{../data/resume} % 个人简历
