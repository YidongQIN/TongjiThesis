% !TEX program = xelatex
\documentclass[degree=doctor,bibtype=numeric,footnotenum=pifont,electronic=true]{tongjithesis}
% 选项列表（*代表默认选项）
...
\bookspine[同济大学 \LaTeX{} 中文 \raisebox{-0.35em}{eng text \LaTeX} 混排 ENGlish]
